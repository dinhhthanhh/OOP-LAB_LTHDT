...
public class Aims {
    ...
    public static void main(String args[]) {
        ...
        Track track1 = new Track(28,"Demons");
        Track track2 = new Track(44,"Angels");
        ...
        book1.addAuthor("JRR Martin", null);
...
public static void storeUpdate() {
    ...
    public static void storeMenu() {
        for (; ; ) {
            ...
            System.out.println("\nOptions: ");
            System.out.println("--------------------------------");
            System.out.println("1. See a media is details");
